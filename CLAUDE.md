...
React SPA frontend for the claude-java-demo backend. Provides a tab-based UI for managing Products and Customers.
...
> use `localhost` here — inside the container that resolves to the container itself.
